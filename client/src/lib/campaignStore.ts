import { Campaign, CampaignStatus, DEFAULT_QUESTIONS } from './types';
import { v4 as uuidv4 } from 'uuid';

const STORAGE_KEY = 'nps_campaigns';

// todo: remove mock functionality - seed campaigns for demo
const createSeedCampaigns = (): Campaign[] => {
  const now = new Date();
    ...
    },
    {
      ...
      messageTemplates: {
        email: {
          ...
          body: "Sehr geehrte/r {{customerName}}, vielen Dank für Ihren Besuch. Bitte teilen Sie uns Ihre Erfahrung mit.",
        },
        sms: {
    ...
    },
    {
      ...
      messageTemplates: {
        email: {
          ...
          body: "عزيزي {{customerName}}، شكراً لاختيارك لنا. يرجى مشاركة تجربتك معنا.",
        },
        sms: {
