...
const mockCampaign: Campaign = {
  ...
  outcomeRules: { detractors: { createFidsparkDispute: true, createLeadsparkTask: false, createWebhookTask: false, webhookUrl: "", webhookSecret: "", webhookPayloadTemplate: "" }, nonResponders: { createFidsparkDispute: false, createLeadsparkTask: false, createWebhookTask: false }, promoters: { notifyFidspark: true }, passives: { noAction: true } },
  ...
  insights: { npsScore: 72, responseCount: 245, responseRate: 34.5, promotersPercent: 58, passivesPercent: 22, detractorsPercent: 20, responseSources: { email: 145, sms: 62, aiCall: 38 }, npsOverTime: [], aiAgentMetrics: { totalCalls: 156, successfulCalls: 124, unreachable: 32, avgCallDuration: 180, escalationReasons: [] }, detractorTickets: [], detractorTasks: [] },
  createdAt: new Date(),
  updatedAt: new Date(),
};
